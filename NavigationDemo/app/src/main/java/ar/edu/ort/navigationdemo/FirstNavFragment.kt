...
class FirstNavFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        findNavController().navigate(R.id.action_firstNavFragment_to_secondNavigationFragment)
        //Navigation.createNavigateOnClickListener(R.id.action_firstNavFragment_to_secondNavigationFragment, null)
        }
    }
